...
!(function (e, t) {
	...
	!(function () {
		...
		try {
			g.apply((n = o.call(O.childNodes)), O.childNodes),
		...
		function Z(e, t, n, i) {
			...
			if (!i && (le(t), (t = t || c), p)) {
				...
				if (!(D[e + ' '] || (h && h.test(e)))) {
					if (((u = e), (v = t), 1 === m && (R.test(e) || W.test(e)))) {
						for (
							((v = (V.test(e) && ae(t.parentNode)) || t) == t && f.scope) ||
								((a = t.getAttribute('id'))
					...
					try {
						return g.apply(n, v.querySelectorAll(u)), n;
					} catch (t) {
						D(e, !0);
					} finally {
			...
			return n != c && 9 === n.nodeType && n.documentElement
				? ((u = (c = n).documentElement),
				  ...
				  (f.getById = ne(function (e) {
						return (
							(u.appendChild(e).id = k.expando),
							!c.getElementsByName || !c.getElementsByName(k.expando).length
						);
				  })),
						...
						return (
							...
							(!f.sortDetached && t.compareDocumentPosition(e) === n)
								? e === c || (e.ownerDocument == O && Z.contains(O, e))
									? -1
									: t === c || (t.ownerDocument == O && Z.contains(O, t))
									? 1
									: s
		...
		(Z.attr = function (e, t) {
			...
			var n = i.attrHandle[t.toLowerCase()],
				o = n && d.call(i.attrHandle, t.toLowerCase()) ? n(e, t, !p) : void 0;
							...
							: function (t, n, l) {
									...
									if (v) {
										if (r) {
											for (; h; ) {
												for (u = t; (u = u[h]); )
													if (a ? S(u, g) : 1 === u.nodeType) return !1;
		...
		function de(e, t) {
			...
			for (a = e, l = [], c = i.preFilter; a; ) {
				...
				(o = W.exec(a)) &&
					((n = o.shift()),
					r.push({ value: n, type: o[0].replace(j, ' ') }),
					(a = a.slice(n.length))),
				i.filter))
					!(o = B[s].exec(a)) ||
						(c[s] && !(o = c[s](o))) ||
			...
			return t ? a.length : a ? Z.error(e) : x(e, l).slice(0);
		}
		function ue(e) {
			...
			return (
				...
				te(function (r, s, l, c) {
					var d,
						...
						w = !e || (!r && t) ? m : he(m, h, e, l, c);
					if (
						(n ? n(w, (f = o || (r ? e : y || i) ? [] : s), l, c) : (f = w), i)
					)
						for (d = he(f, v), i(d, [], l, c), u = d.length; u--; )
							(p = d[u]) && (f[v[u]] = !(w[v[u]] = p));
					if (r) {
						if (o || e) {
							if (o) {
							...
							for (u = f.length; u--; )
								(p = f[u]) &&
									(d = o ? a.call(r, p) : h[u]) > -1 &&
									(r[d] = !(s[d] = p));
						}
					} else (f = he(f === s ? f.splice(y, f.length) : f)), o ? o(null, s, f, c) : g.apply(s, f);
				})
			);
		}
		function ge(e) {
			for (
				...
				if ((n = i.relative[e[d].type])) f = [pe(fe(f), n)];
					...
					if ((n = i.filter[e[d].type].apply(null, e[d].matches))[y]) {
						for (o = ++d; o < s && !i.relative[e[o].type]; o++);
						return ve(
							d > 1 && fe(f),
							d > 1 &&
								ue(
		...
		function ye(e, t) {
			...
			if (!a) {
				for (t || (t = de(e)), n = t.length; n--; )
					(a = ge(t[n]))[y] ? o.push(a) : s.push(a);
				(a = T(
					e,
					(function (e, t) {
						var n = t.length > 0,
							o = e.length > 0,
							s = function (s, a, l, d, u) {
								var f,
									h,
									v,
									y = 0,
								...
								for (
									...
									n && ((f = !v && f) && y--, s && b.push(f));
								}
								if (((y += w), n && w !== y)) {
									for (h = 0; (v = t[h++]); ) v(b, x, a, l);
									if (s) {
										if (y > 0) for (; w--; ) b[w] || x[w] || (x[w] = C.call(d));
										x = he(x);
									}
									g.apply(d, x),
										u &&
		...
		function me(e, t, n, o) {
			...
			if (((n = n || []), 1 === u.length)) {
				if (
					(s = u[0] = u[0].slice(0)).length > 2 &&
					'ID' === (a = s[0]).type &&
					9 === t.nodeType &&
					p &&
					i.relative[s[1].type]
				) {
					if (!(t = (i.find.ID(a.matches[0].replace(G, Q), t) || [])[0]))
						return n;
					d && (t = t.parentNode), (e = e.slice(s.shift().value.length));
				}
				for (
					r = B.needsContext.test(e) ? 0 : s.length;
					r-- && ((a = s[r]), !i.relative[(l = a.type)]);
					...
					if (
						...
						(o = c(
							...
							(V.test(s[0].type) && ae(t.parentNode)) || t,
						))
					) {
		...
		(ce.prototype = i.filters = i.pseudos),
			(i.setFilters = new ce()),
			(f.sortStable = y.split('').sort(H).join('') === y),
			le(),
	...
	(k.filter = function (e, t, n) {
		...
		k.fn.extend({
			...
			is: function (e) {
				return !!I(this, 'string' == typeof e && q.test(e) ? k(e) : e || [], !1)
					.length;
			},
		});
	var z,
		...
		if (((n = n || z), 'string' == typeof e)) {
			...
			if (i[1]) {
				if (
					...
					k.merge(
						this,
						k.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0),
					),
					M.test(i[1]) && k.isPlainObject(t))
				)
			...
			function (e, t) {
				k.fn[e] = function (n, i) {
					...
					return (
						...
						this.length > 1 &&
							(F[e] || k.uniqueSort(o), R.test(e) && o.reverse()),
						this.pushStack(o)
					);
				};
			},
								...
								return function () {
										...
										c = function () {
											...
											if (!(t < r)) {
												...
												(c =
													...
													h(c)
														? o
															? c.call(e, s(r, n, U, o), s(r, n, X, o))
															: (r++,
															  c.call(
																	e,
																	s(r, n, U, o),
																	s(r, n, X, o),
																	s(r, n, U, n.notifyWith),
															  ))
														: (i !== U && ((a = void 0), (l = [e])),
														  (o || n.resolveWith)(a, l));
											}
											...
											: function () {
													try {
														...
														k.Deferred.exceptionHook &&
															k.Deferred.exceptionHook(e, d.error),
															t + 1 >= r &&
																(i !== X && ((a = void 0), (l = [e])),
																n.rejectWith(a, l));
													}
									...
									t
										...
										: (k.Deferred.getErrorHook
												? (d.error = k.Deferred.getErrorHook())
												: k.Deferred.getStackHook &&
												  (d.error = k.Deferred.getStackHook()),
										  e.setTimeout(d));
								};
							}
							return k
								.Deferred(function (e) {
									n[0][3].add(s(0, e, h(o) ? o : U, e.notifyWith)),
										n[1][3].add(s(0, e, h(t) ? t : U)),
										n[2][3].add(s(0, e, h(i) ? i : X));
								})
								.promise();
						},
						promise: function (e) {
		...
		k.extend({
			...
			ready: function (e) {
				(!0 === e ? --k.readyWait : k.isReady) ||
					((k.isReady = !0),
					(!0 !== e && --k.readyWait > 0) || G.resolveWith(g, [k]));
			},
		}),
		(k.ready.then = G.then),
	...
	var J = function e(t, n, i, o, r, s, a) {
			var l = 0,
				c = t.length,
				d = null == i;
			if ('object' === w(i))
	...
	pe.getRootNode &&
		(fe = function (e) {
			return (
				k.contains(e.ownerDocument, e) || e.getRootNode(he) === e.ownerDocument
			);
		});
	var ve = function (e, t) {
		return (
			'none' === (e = t || e).style.display ||
			('' === e.style.display && fe(e) && 'none' === k.css(e, 'display'))
		);
	};
	function ge(e, t, n, i) {
		var o,
	...
	(be = g.createDocumentFragment().appendChild(g.createElement('div'))),
		...
		return (
			(n =
				void 0 !== e.getElementsByTagName
					...
					: []),
			void 0 === t || (t && S(e, t)) ? k.merge([e], n) : n
		);
	}
	function Ae(e, t) {
	...
	function je(e, t, n, i, o) {
		for (
			...
			if ((r = e[f]) || 0 === r)
				if ('object' === w(r)) k.merge(p, r.nodeType ? [r] : r);
				else if (Ee.test(r)) {
					for (
		...
		for (u.textContent = '', f = 0; (r = p[f++]); )
			if (i && k.inArray(r, i) > -1) o && o.push(r);
				...
				((c = fe(r)), (s = $e(u.appendChild(r), 'script')), c && Ae(s), n)
			)
				for (d = 0; (r = s[d++]); ) Se.test(r.type || '') && n.push(r);
		return u;
	}
	var De = /^([^.]*)(?:\.(.+)|)/;
	function He() {
			  ...
			  k.event.add(e, t, {
					...
					handler: function (e) {
						...
						if (1 & e.isTrigger && this[t]) {
							...
							i &&
								(oe.set(this, t, k.event.trigger(i[0], i.slice(1), this)),
								e.stopPropagation(),
								(e.isImmediatePropagationStopped = He));
					},
			  }))
			: void 0 === oe.get(e, t) && k.event.add(e, t, He);
	}
	(k.event = {
		global: {},
		...
		special: {
			...
			click: {
				setup: function (e) {
					var t = this || e;
					return (
						ke.test(t.type) && t.click && S(t, 'input') && Pe(t, 'click', !0),
						!1
					);
				},
				trigger: function (e) {
		...
		k.each({ focus: 'focusin', blur: 'focusout' }, function (e, t) {
			...
			(k.event.special[e] = {
				setup: function () {
					var i;
					if ((Pe(this, e, !0), !g.documentMode)) return !1;
	...
	function Re(e, t) {
		...
		if (1 === t.nodeType) {
			...
			re.hasData(e) &&
				((r = re.access(e)), (s = k.extend({}, r)), re.set(t, s));
		}
	}
	function Fe(e, t) {
	...
	function _e(e, t, n, i) {
		...
		var o,
			...
			g = t[0],
			y = h(g);
		if (y || (p > 1 && 'string' == typeof g && !f.checkClone && qe.test(g)))
			return e.each(function (o) {
				var r = e.eq(o);
				y && (t[0] = g.call(this, o, r.html())), _e(r, t, n, i);
			});
		if (
			p &&
			((s = (o = je(t, e[0].ownerDocument, !1, e, i)).firstChild),
			1 === o.childNodes.length && (o = s),
			s || i)
		) {
			for (l = (a = k.map($e(o, 'script'), ze)).length; u < p; u++)
				(c = o),
					u !== v &&
						((c = k.clone(c, !0, !0)), l && k.merge(a, $e(c, 'script'))),
					n.call(e[u], c, u);
			if (l)
				for (d = a[a.length - 1].ownerDocument, k.map(a, We), u = 0; u < l; u++)
					(c = a[u]),
						Se.test(c.type || '') &&
							...
							(c.src && 'module' !== (c.type || '').toLowerCase()
								...
								: m(c.textContent.replace(Me, ''), c, d));
		}
		return e;
	}
	function Be(e, t, n) {
		for (var i, o = t ? k.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
			n || 1 !== i.nodeType || k.cleanData($e(i)),
				i.parentNode &&
					(n && fe(i) && Ae($e(i, 'script')), i.parentNode.removeChild(i));
		return e;
	}
	k.extend({
		...
		clone: function (e, t, n) {
			...
			if (
				...
				for (s = $e(a), i = 0, o = (r = $e(e)).length; i < o; i++)
					Fe(r[i], s[i]);
			if (t)
				if (n)
					for (r = r || $e(e), s = s || $e(a), i = 0, o = r.length; i < o; i++)
						Re(r[i], s[i]);
				else Re(e, a);
			return (
				(s = $e(a, 'script')).length > 0 && Ae(s, !l && $e(e, 'script')), a
			);
		},
		...
		k.fn.extend({
			...
			empty: function () {
				for (var e, t = 0; null != (e = this[t]); t++)
					1 === e.nodeType && (k.cleanData($e(e, !1)), (e.textContent = ''));
				return this;
			},
			clone: function (e, t) {
				return (
					...
					function (e) {
						...
						if (
							...
							try {
								for (; n < i; n++)
									1 === (t = this[n] || {}).nodeType &&
										(k.cleanData($e(t, !1)), (t.innerHTML = e));
								t = 0;
							} catch (e) {}
						}
			...
			replaceWith: function () {
				...
				return _e(
					...
					function (t) {
						...
						k.inArray(this, e) < 0 &&
							(k.cleanData($e(this)), n && n.replaceChild(t, this));
					},
					e,
				);
			},
		...
		k.each(
			...
			function (e, t) {
				k.fn[e] = function (e) {
					for (var n, i = [], o = k(e), r = o.length - 1, a = 0; a <= r; a++)
	...
	function st(e, t, n, i, o, r) {
		...
		for (; s < 4; s += 2)
			'margin' === n && (c += k.css(e, n + ue[s], !0, o)),
				i
					? ('content' === n && (l -= k.css(e, 'padding' + ue[s], !0, o)),
					  'margin' !== n &&
							(l -= k.css(e, 'border' + ue[s] + 'Width', !0, o)))
					: ((l += k.css(e, 'padding' + ue[s], !0, o)),
					  'padding' !== n
							? (l += k.css(e, 'border' + ue[s] + 'Width', !0, o))
							: (a += k.css(e, 'border' + ue[s] + 'Width', !0, o)));
		return (
			!i &&
				r >= 0 &&
				(l +=
	...
	k.extend({
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var o,
					...
					c = e.style;
				if (
					(l || (t = tt(a)), (s = k.cssHooks[t] || k.cssHooks[a]), void 0 === n)
				)
		...
		k.each(['height', 'width'], function (e, t) {
			k.cssHooks[t] = {
				get: function (e, n, i) {
					if (n)
						return !nt.test(k.css(e, 'display')) ||
			...
			_default: {
				...
				set: function (e) {
					k.fx.step[e.prop]
						? k.fx.step[e.prop](e)
						: 1 !== e.elem.nodeType ||
						  (!k.cssHooks[e.prop] && null == e.elem.style[tt(e.prop)])
						? (e.elem[e.prop] = e.now)
	...
	function yt(e, t, n) {
		...
		for (
			...
			if ((i = yt.prefilters[r].call(c, e, d, c.opts)))
				return (
					h(i.stop) &&
		...
		tweeners: {
			'*': [
				function (e, t) {
					...
					return ge(n.elem, e, de.exec(t), n), n;
				},
			],
		},
				...
				if ((l = !k.isEmptyObject(t)) || !k.isEmptyObject(f))
					...
					f))
						l ||
							...
							v && we([e], !0),
							p.done(function () {
								for (i in (v || we([e]), oe.remove(e, 'fxshow'), f))
									k.style(e, i, f[i]);
							})),
							(l = gt(v ? g[i] : 0, i, p)),
							i in g ||
		...
		k.fn.extend({
			addClass: function (e) {
				...
				return h(e)
					...
					? this.each(function () {
							if (
								((i = Tt(this)), (n = 1 === this.nodeType && ' ' + kt(i) + ' '))
							) {
								for (r = 0; r < t.length; r++)
									(o = t[r]), n.indexOf(' ' + o + ' ') < 0 && (n += o + ' ');
								(s = kt(n)), i !== s && this.setAttribute('class', s);
							}
					  })
					: this;
			},
					...
					: ((n = St(e)),
					  this.each(function () {
							if (a)
								...
								(void 0 !== e && 'boolean' !== s) ||
									((i = Tt(this)) && oe.set(this, '__className__', i),
									this.setAttribute &&
										this.setAttribute(
											'class',
	...
	k.extend(k.event, {
		trigger: function (t, n, i, o) {
			...
			if (
				...
				3 !== i.nodeType &&
					8 !== i.nodeType &&
					!jt.test(m + k.event.triggered) &&
					(m.indexOf('.') > -1 &&
						((w = m.split('.')), (m = w.shift()), w.sort()),
					(c = m.indexOf(':') < 0 && 'on' + m),
					((t = t[k.expando]
						? t
						: new k.Event(m, 'object' === _typeof(t) && t)).isTrigger = o
						? 2
						: 3),
					(t.namespace = w.join('.')),
				...
				if (!o && !p.noBubble && !v(i)) {
					for (
						l = p.delegateType || m, jt.test(l + m) || (s = s.parentNode);
						s;
						s = s.parentNode
					)
						y.push(s), (a = s);
				...
				for (r = 0; (s = y[r++]) && !t.isPropagationStopped(); )
					(f = s),
						...
						(u =
							(oe.get(s, 'events') || Object.create(null))[t.type] &&
							oe.get(s, 'handle')) && u.apply(s, n),
						(u = c && s[c]) &&
							u.apply &&
							ne(s) &&
				...
				return (
					...
					o ||
						...
						(c &&
							...
							((a = i[c]) && (i[c] = null),
							(k.event.triggered = m),
							t.isPropagationStopped() && f.addEventListener(m, Dt),
							i[m](),
							t.isPropagationStopped() && f.removeEventListener(m, Dt),
						...
						u
							? (f.ifModified &&
							  ...
							  204 === t || 'HEAD' === f.type
									...
									: 304 === t
									? (T = 'notmodified')
									: ((T = b.state), (p = b.data), (u = !(g = b.error))))
							: ((g = T), (!t && T) || ((T = 'error'), t < 0 && (t = 0))),
						(S.status = t),
						(S.statusText = (n || T) + ''),
						u ? y.resolveWith(h, [p, T, S]) : y.rejectWith(h, [S, T, g]),
						S.statusCode(w),
						(w = void 0),
						d && v.trigger(u ? 'ajaxSuccess' : 'ajaxError', [S, f, u ? p : g]),
						m.fireWith(h, [S, T]),
						d &&
	...
	k.ajaxSetup({
		...
		jsonpCallback: function () {
			var e = Kt.pop() || k.expando + '_' + At.guid++;
			return (this[e] = !0), e;
		},
	}),
		k.ajaxPrefilter('json jsonp', function (t, n, i) {
			...
			if (a || 'jsonp' === t.dataTypes[0])
				return (
					...
					i.always(function () {
						void 0 === r ? k(e).removeProp(o) : (e[o] = r),
		...
		(f.createHTMLDocument =
			(((Jt = g.implementation.createHTMLDocument('').body).innerHTML =
				'<form></form><form></form>'),
		...
		(k.fn.load = function (e, t, n) {
			var i,
				...
				a = e.indexOf(' ');
			return (
				a > -1 && ((i = kt(e.slice(a))), (e = e.slice(0, a))),
				h(t)
					? ((n = t), (t = void 0))
		...
		k.each(['top', 'left'], function (e, t) {
			k.cssHooks[t] = Je(f.pixelPosition, function (e, n) {
				if (n)
					return (n = Qe(e, t)), Ue.test(n) ? k(e).position()[t] + 'px' : n;
			});
		}),
...
var testimonials = [
	...
	info = document.getElementById('review'),
	prevBtn = document.querySelector('.prev-btn'),
	nextBtn = document.querySelector('.next-btn'),
	currentItem = 0;
function showPerson() {
	var e = testimonials[currentItem];
	(img.src = e.img), (name.textContent = e.name), (info.textContent = e.text);
}
window.addEventListener('DOMContentLoaded', function () {
	showPerson(currentItem);
}),
	nextBtn.addEventListener('click', function () {
		++currentItem > testimonials.length - 1 && (currentItem = 0), showPerson();
	}),
	prevBtn.addEventListener('click', function () {
		--currentItem < 0 && (currentItem = testimonials.length - 1), showPerson();
	}),
	$(function () {
		var e,
			t,
		...
		$(window).on('scroll', function () {
			$(window).scrollTop() ? n.css('opacity', 0.9) : n.css('opacity', 1);
		}),
			$(window).on('scroll', function () {
				$(window).scrollTop() + $(window).height() > $('#contacts').offset().top
					? $('#topBtn').fadeIn()
					: $('#topBtn').fadeOut();
			}),
			...
			o.on('click', function () {
				$(this).toggleClass('close'), i.toggleClass('active-menu');
			}),
			r.on('click', function () {
			...
			r.on('click', function () {
				var e = $(this).attr('href'),
					t = $(e).offset().top;
				return $('html, body').animate({ scrollTop: t - 80 }, 500), !1;
			}),
			s.on('click', function () {
				var e = $(this).attr('href'),
					t = $(e).offset().top;
